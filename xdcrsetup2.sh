...
gcloud beta container --project santosh-350416 clusters create xdcr2 --zone us-east4-a --no-enable-basic-auth --cluster-version "1.22.6-gke.300" --machine-type "n2-standard-2" --disk-type "pd-standard" --disk-size "100" --num-nodes "3"

#connecting to the cluster
gcloud container clusters get-credentials xdcr2 --zone us-east4-a --project santosh-350416
...
kubectl port-forward xdcr2-voltdb-cluster-0 8080 21212

kubectl get all | grep LoadBalancer | sed -n '1,1p' |awk '{ print $4 }' > temp2
