...
gcloud beta container --project santosh-350416  clusters create xdcr2 --zone us-west1-a --no-enable-basic-auth --cluster-version "1.22.8-gke.201" --machine-type "n2-standard-2" --num-nodes 5 --disk-type "pd-standard" --disk-size "100"
