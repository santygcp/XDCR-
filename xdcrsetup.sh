...
gcloud beta container --project santosh-350416  clusters create xdcr1 --zone us-central1-a --no-enable-basic-auth --cluster-version "1.22.6-gke.300" --machine-type "n2-standard-2" --num-nodes 4 --disk-type "pd-standard" --disk-size "100"
